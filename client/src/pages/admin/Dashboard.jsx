      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <Card className="p-6 border-l-4 border-amber-500 dark:bg-neutral-800 dark:border-amber-400 hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-start justify-between">
              <div>
                <div className="text-4xl font-extrabold text-amber-600 dark:text-amber-400">{pendingIssues.length}</div>
                <div className="text-slate-600 dark:text-neutral-300 mt-2 font-bold text-xs uppercase tracking-wider">Pending Issues</div>
                <p className="text-xs text-slate-400 dark:text-neutral-500 mt-1.5 font-medium">Awaiting manual review</p>
              </div>
          ...
          <Card className="p-6 border-l-4 border-blue-500 dark:bg-neutral-800 dark:border-blue-400 hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-start justify-between">
              <div>
                <div className="text-4xl font-extrabold text-blue-600 dark:text-blue-400">{redoRequired.length}</div>
                <div className="text-slate-600 dark:text-neutral-300 mt-2 font-bold text-xs uppercase tracking-wider">Redo Required</div>
                <p className="text-xs text-slate-400 dark:text-neutral-500 mt-1.5 font-medium">Providers taking action</p>
              </div>
          ...
          <Card className="p-6 border-l-4 border-purple-500 dark:bg-neutral-800 dark:border-purple-400 hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-start justify-between">
              <div>
                <div className="text-4xl font-extrabold text-purple-600 dark:text-purple-400">{refundPending.length}</div>
                <div className="text-slate-600 dark:text-neutral-300 mt-2 font-bold text-xs uppercase tracking-wider">Refunds Pending</div>
                <p className="text-xs text-slate-400 dark:text-neutral-500 mt-1.5 font-medium">Money back to customers</p>
              </div>
          ...
          <Card className="p-6 border-l-4 border-slate-500 dark:bg-neutral-800 dark:border-neutral-500 hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-start justify-between">
              <div>
                <div className="text-4xl font-extrabold text-slate-700 dark:text-neutral-300">{issues.length}</div>
                <div className="text-slate-600 dark:text-neutral-300 mt-2 font-bold text-xs uppercase tracking-wider">Total Lifetime</div>
                <p className="text-xs text-slate-400 dark:text-neutral-500 mt-1.5 font-medium">Cumulative issue count</p>
              </div>
              <div className="w-12 h-12 rounded-xl bg-slate-100 dark:bg-neutral-700 flex items-center justify-center">
                <svg className="w-6 h-6 text-slate-700 dark:text-neutral-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex border-b border-slate-200 dark:border-neutral-700 mb-8">
          ...
          <button
            ...
            className={`px-6 py-3 font-semibold transition-all ${activeTab === 'reviews'
              ? 'border-b-2 border-amber-600 dark:border-amber-400 text-amber-600 dark:text-amber-400'
              : 'text-slate-500 dark:text-neutral-400 hover:text-slate-700 dark:hover:text-neutral-300'
              }`}
          >
        ...
        {activeTab === 'messages' ? (
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h2 className="text-2xl font-bold text-slate-900 dark:text-neutral-100">Service Reviews</h2>
                <p className="text-slate-600 dark:text-neutral-400 mt-1">View and manage customer reviews across all services</p>
              </div>
              <PrimaryButton onClick={fetchReviews} variant="outline">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                </svg>
                Refresh
            ...
            {reviewsLoading ? (
              <div className="text-center py-12">
                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 dark:border-blue-400 mx-auto"></div>
                <p className="mt-4 text-slate-600 dark:text-neutral-400">Loading reviews...</p>
              </div>
              ...
              <div className="text-center py-12">
                ...
                <p className="text-slate-600 dark:text-neutral-400 text-lg">No reviews found</p>
                <p className="text-slate-500 dark:text-neutral-500 mt-2">Try adjusting your search</p>
              </div>
            ) : (
              <div className="space-y-4">
                  ...
                  <Card key={review._id} className="p-6 hover:shadow-lg transition-shadow">
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                      <div className="flex-1">
                        ...
                        {review.comment && (
                          <p className="text-sm text-slate-700 dark:text-neutral-300 mb-3">
                            "{review.comment}"
                          </p>
                        )}
                      ...
                      <div className="flex-shrink-0 flex flex-col gap-2 items-stretch lg:items-end">
                        <span
                          className={`inline-flex px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wide ${review.isApproved
                        ...
                        <button
                          ...
                          className="mt-1 px-3 py-2 text-xs font-semibold text-rose-600 hover:text-rose-700 border border-rose-200 dark:border-rose-700 rounded-lg hover:bg-rose-50 dark:hover:bg-rose-900/30 transition-all"
                        >
                          Delete Review
                        </button>
                      </div>
