...
const CustomerDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50/40 to-purple-50 dark:from-neutral-950 dark:via-indigo-950/20 dark:to-neutral-950 py-12 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-12 animate-fade-in">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold font-display bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 dark:from-blue-400 dark:via-indigo-400 dark:to-purple-400 bg-clip-text text-transparent tracking-tight mb-3">
                Welcome back, {user?.name?.split(' ')[0] || 'there'}! 👋
              </h1>
              <p className="text-xl text-slate-600 dark:text-neutral-300 font-medium">Find the best professionals for your home needs today</p>
            </div>
            <div className="flex gap-3 flex-wrap">
              <button
                onClick={() => navigate('/customer/profile')}
                className="px-6 py-3.5 bg-white/80 dark:bg-neutral-800/80 backdrop-blur-sm border-2 border-slate-200 dark:border-neutral-700 rounded-2xl font-bold text-slate-900 dark:text-neutral-100 shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center gap-2.5"
              >
              ...
              <button
                ...
                className="px-6 py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl font-bold text-white shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 hover:scale-105 transition-all duration-300 flex items-center gap-2.5"
              >
        ...
        {loading ? (
          ...
          <>
            ...
            {/* Recent Bookings */}
            <div className="bg-white/80 dark:bg-neutral-800/80 backdrop-blur-sm rounded-3xl shadow-xl border border-slate-200 dark:border-neutral-700 p-8">
              ...
              {recentBookings.length === 0 ? (
                ...
                <div className="space-y-4">
                  {recentBookings.map((booking) => (
                    <div
                      key={booking._id}
                      className="flex items-center gap-4 p-5 bg-gradient-to-r from-slate-50 to-blue-50/30 dark:from-neutral-800 dark:to-indigo-900/20 hover:from-blue-50 hover:to-indigo-50 dark:hover:from-neutral-700 dark:hover:to-indigo-900/30 rounded-2xl transition-all duration-300 group cursor-pointer border border-slate-100 dark:border-neutral-700 hover:border-blue-200 dark:hover:border-indigo-800 hover:shadow-lg"
