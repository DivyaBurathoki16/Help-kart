        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full pt-24 pb-20 lg:pt-32 lg:pb-32">
          <div className="max-w-2xl lg:max-w-3xl">
            ...
            <p className="text-lg sm:text-xl leading-relaxed text-white/95 max-w-xl mb-10 lg:mb-12 font-medium">
              {pageContent?.hero?.description || 'From plumbing to electrical, cleaning to repairs — get verified professionals at your home with just a few clicks. Fast, affordable, and hassle-free.'}
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 dark:text-neutral-300 max-w-2xl mx-auto">
              {pageContent?.expertSection?.subtitle || 'Browse our wide range of professional home services, delivered by verified experts in your area.'}
            </p>
          </div>
      ...
      <section className="py-20 bg-white dark:bg-neutral-950 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 dark:text-neutral-300 max-w-2xl mx-auto">
              {pageContent?.popularSection?.subtitle || 'Most booked services by our customers. Quick, reliable, and affordable.'}
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center mb-24">
            ...
            <p className="text-5xl font-black tracking-tight text-slate-900 dark:text-neutral-100 sm:text-6xl">
              {pageContent?.featuresSection?.subheading || 'Quality you can trust, speed you can rely on.'}
            </p>
          </div>
          ...
          <div className="card bg-slate-900 p-12 sm:p-24 relative overflow-hidden border-none">
            ...
            <div className="relative z-10 text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl leading-10 text-slate-300 mb-12 font-medium">
                {pageContent?.ctaSection?.description || 'Join thousands of customers who have simplified their lives with HelpKart. Fast, reliable, and always at your service.'}
              </p>
