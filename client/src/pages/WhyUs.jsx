    ...
    pageContent?.reasons || [
      {
        ...
        description: 'All providers are background-checked, identity-verified, and rated by real customers.',
        color: 'blue',
      },
      {
        title: 'Transparent pricing',
        description: "Clear, upfront pricing with no hidden fees. Know what you'll pay before you book.",
        color: 'emerald',
      },
      {
        title: 'Fast, reliable support',
        description: 'Our support team is available to help with bookings, reschedules, and any issues.',
        color: 'indigo',
      },
      {
        title: 'Coverage for every need',
        description: 'From plumbing to cleaning, AC repair to handyman tasks — find experts for every job.',
        color: 'sky',
      },
    ];
