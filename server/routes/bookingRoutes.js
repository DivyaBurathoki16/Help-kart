...
<<<<<<< HEAD
    ...
    // Notify provider about the new booking (fire-and-forget)
    try {
      const provider = await Provider.findById(providerId).populate('user', 'name email');
      const providerUser = provider?.user;

      await sendNewBookingNotificationToProvider({
