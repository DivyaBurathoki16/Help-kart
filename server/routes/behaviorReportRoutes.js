...
<<<<<<< HEAD
        ...
        if (provider) {
            ...
            // Notify provider that a behavior report has been submitted
            try {
                await sendBehaviorReportSubmittedEmail({
...
<<<<<<< HEAD
                ...
                try {
                    await sendBehaviorReportReviewedEmail({
                        providerEmail: provider.user?.email,
                        providerName: provider.businessName || provider.user?.name || 'Provider',
                        actionTaken,
                        adminNotes,
                        issueType: report.issueType,
                        bookingId: report.booking?.toString(),
                    });
                } catch (notifyError) {
